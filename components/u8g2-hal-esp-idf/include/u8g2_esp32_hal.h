...
#define I2C_MASTER_FREQ_HZ 1000000    //  I2C master clock frequency (1 MHz for fast mode)
...
/**
 * Set external I2C bus handle for shared bus usage.
 * Call this before u8g2_InitDisplay() if you want to use an existing I2C bus.
 *
 * @param bus_handle I2C master bus handle created externally
 */
